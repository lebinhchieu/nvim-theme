...
return {
  ...
  Cursor = { fg = p.base.bg, bg = p.accent.orange_bright },
  lCursor = { link = "Cursor" },
  ...
  IncSearch = { bg = p.accent.orange_bright, fg = p.base.bg },
  ...
  Bold = { bold = true },
  Italic = { italic = true },
  Todo = { fg = p.base.bg, bg = p.accent.orange_bright, bold = true },
